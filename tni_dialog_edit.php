...
$myform = new form("tni_dialog_form_edit");
...
$myform->input_text("Date Created", "date_created","hide"); /* use hide only so that getjson put the data and set it in this input box */
